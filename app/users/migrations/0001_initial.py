    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(max_length=25, null=True, validators=[django.core.validators.RegexValidator('^[a-z A-Z]*$', 'Only Alphabetic characters allowed')], verbose_name='Name as on Passport')),
