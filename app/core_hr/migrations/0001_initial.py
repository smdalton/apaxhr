# Generated by Django 2.2.9 on 2020-01-03 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(null=True, storage=apaxhr.storage_backends.PrivateMediaStorage(), upload_to='work_permits')),
                ('image', models.ImageField(blank=True, null=True, storage=apaxhr.storage_backends.PrivateMediaStorage(), upload_to='work_permits')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(storage=apaxhr.storage_backends.PrivateMediaStorage(), upload_to='passports')),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core_hr.Employee')),
            ],
        ),
    ]
