# Generated by Django 3.0 on 2019-12-27 08:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration', models.DateTimeField(default=datetime.datetime(2019, 12, 27, 8, 8, 40, 797220))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration', models.DateTimeField(default=datetime.datetime(2019, 12, 27, 8, 8, 40, 797220))),
                ('issued', models.DateTimeField(default=datetime.datetime(2019, 12, 27, 8, 8, 40, 797220))),
                ('pdf', models.FileField(null=True, upload_to='document_images')),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core_hr.Employee')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration_date', models.DateTimeField(default=datetime.datetime(2019, 12, 27, 8, 8, 40, 797220))),
                ('issue_date', models.DateTimeField(default=datetime.datetime(2019, 12, 27, 8, 8, 40, 797220))),
