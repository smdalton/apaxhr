# Generated by Django 3.0 on 2019-12-26 11:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration', models.DateTimeField(default=datetime.datetime(2019, 12, 26, 11, 24, 49, 195350))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration', models.DateTimeField(default=datetime.datetime(2019, 12, 26, 11, 24, 49, 195350))),
                ('issued', models.DateTimeField(default=datetime.datetime(2019, 12, 26, 11, 24, 49, 195350))),
                ('pdf', models.FileField(null=True, upload_to='document_images')),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core_hr.Employee')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiration_date', models.DateTimeField(default=datetime.datetime(2019, 12, 26, 11, 24, 49, 195350))),
                ('issue_date', models.DateTimeField(default=datetime.datetime(2019, 12, 26, 11, 24, 49, 195350))),
